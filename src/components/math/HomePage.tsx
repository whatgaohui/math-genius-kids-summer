...
import { Star, Zap, Flame, ChevronRight, Trophy, Coins, X, BookOpen, Target, BarChart3, ArrowRight, Clock, TrendingUp, BookOpenCheck, PawPrint, Award, ListChecks, FileBarChart } from 'lucide-react';
